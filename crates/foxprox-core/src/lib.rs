...
pub use dns::{
    parse_dns_query, parse_dns_response_observation, synthesize_dns_response, BrokerDnsResponse,
    DnsCache, DnsObservation, DnsParseError, DnsQuestion, DnsRecordType, StaticDnsRecord,
    StaticDnsResolver,
};
...
pub use kernel::{audit_backpressure_decision, VerificationKernel};
...
pub use packet::{
    ...
    Icmpv4EchoRequest, PacketError, ParsedIpPacket, Tcpv4Segment, Udpv4Packet,
